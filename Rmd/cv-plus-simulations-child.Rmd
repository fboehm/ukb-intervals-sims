...
fam_all <- vroom::vroom(here::here("dat", paste0("hsq", h2, "_pcausal", pc), "sim_traits", "fam_all_subjects", paste0("qn_traits_all_subjects_hsq", h2, "_pcausal", pc, ".fam")), col_names = FALSE)
##
phe_num <- x
fam_file <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), "gemma", "chr1.fam")
  # read fam file
...
for (cross_num in 1:5){
  ...
  for (chr_num in 1:22){
    ...
    profile_fn <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), "DBSLMM", pfn)
  ...
  # read idx file
  idx_fn <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), paste0("test-ids-fold", cross_num, ".txt")) 
...
```{r, results='hide', message = FALSE}
verif_ids_fn <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), "verification-ids.txt")
verif_ids <- vroom::vroom(verif_ids_fn, col_names = FALSE)
verif_fn <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), "verification", paste0("pheno", phe_num, "_hsq", h2, "_pcausal", pc,".txt"))
...
for (cross_num in 1:5){
  foo <- list()
  for (chr_num in 1:22){
    fn <- here::here("dat", paste0("hsq", h2, "_pcausal", pc), "verification", paste0("allele-scores_hsq", h2, "_pcausal", pc), paste0("pred_ukb_pheno", phe_num, "_fold", cross_num, "_chr", chr_num, "_best.dbslmm.txt.profile"))
