...
# GOAL: Create a set of plink files for Chr1 for use in simulating traits with GCTA
dir=~/research/ukb-intervals-sims/hapmap3/hm3_ukb/
subject_list=~/research/ukb-intervals-sims/hapmap3-136k/subjects_for_sims-136k.txt
outdir=~/research/ukb-intervals-sims/hapmap3-136k/plink_files_for_sims/
