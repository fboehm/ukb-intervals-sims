...
#SBATCH --array=1
#SBATCH --output=/net/mulan/home/fredboe/research/ukb-intervals-sims/cluster_outputs/02_LDpred2_ukb_thread5_%a.out
...
if [[ "$dat" == "continuous" ]]
then
summ=~/research/ukb-intervals-sims/dat/hsq${hsq}_pcausal${pc}/gemma/output/summary_ukb_pheno${p}_fold${cross}_chr
