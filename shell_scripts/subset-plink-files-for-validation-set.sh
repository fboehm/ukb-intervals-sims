...
idxSub=~/research/ukb-intervals-sims/hapmap3/subjects_for_sims_validation.txt
let chr=1
      bfileAll=~/research/ukb-intervals-sims/hapmap3/plink_files_for_sims/chr${chr}
      bfileSub=~/research/ukb-intervals-sims/dat-quant/validation/allchr${chr}
      bfileSubP=~/research/ukb-intervals-sims/dat-quant/validation/chr${chr}
