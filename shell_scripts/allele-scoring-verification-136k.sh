...
then
# bfile
bfile=~/research/ukb-intervals-sims/hapmap3-136k/plink_files_for_sims/chr${chr}
idxverif=~/research/ukb-intervals-sims/hapmap3-136k/subjects_for_sims_verification-136k.txt
#esteffdbslmmt=${compstr}05_internal_c/pheno${p}/DBSLMM/summary_hm3_cross${cross}_chr${chr}_best.dbslmm.txt
esteffdbslmmt=~/research/ukb-intervals-sims/dat-quant-136k/DBSLMM/scenario${scenario}/${distribution}/hsq${hsq}/summary_ukb_pheno${p}_scenario${scenario}_${distribution}_hsq${hsq}_fold${fold}_chr${chr}_best.dbslmm.txt
outpath=~/research/ukb-intervals-sims/dat-quant-136k/verification/allele-scores/scenario${scenario}/${distribution}/hsq${hsq}
preddbslmmt=${outpath}/pred_replicate${p}_fold${fold}_chr${chr}_best.dbslmm.txt
mkdir -p ${outpath}
