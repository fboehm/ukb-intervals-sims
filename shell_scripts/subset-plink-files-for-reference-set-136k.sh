...
idxSub=~/research/ukb-intervals-sims/hapmap3-136k/subjects_for_sims_reference-136k.txt
let chr=1
      bfileAll=~/research/ukb-intervals-sims/hapmap3-136k/plink_files_for_sims/chr${chr}
      bfileSub=~/research/ukb-intervals-sims/dat-quant-136k/reference/allchr${chr}
      bfileSubP=~/research/ukb-intervals-sims/dat-quant-136k/reference/chr${chr}
